        ...
        <div class="border border-gray-100 text-gray-100   rounded-lg shadow w-auto mx-auto flex">
            ...
            <div class="w-1/2 pl-4 flex flex-col justify-center items-center">
                ...
                <form action="" method="POST">
                    @csrf
                    @method('DELETE')
                    <x-danger-button type="submit" class="text-red-100 bg-transparent border border-red-100 rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-75 px-6 py-3">
                        Törlés
                    </x-danger-button>
                </form>
                @else
