            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="houseNumber" class="col-md-4 col-form-label text-md-end">{{ __('House number') }}</label>

                            <div class="col-md-6">
                                <input id="houseNumber" type="text" class="form-control @error('name') is-invalid @enderror" name="houseNumber" value="{{ old('houseNumber') }}" required autocomplete="houseNumber" autofocus>
